...
public class ModelTask implements NetSearchTask<String>, SaveLocalTask, DeleteLocalTask,
        LocalSearchHistoryTask<SearchHistory>, LocalPlayTask<PlayHistory> {
    ...
    @Override
    public void getSearchHistory(LoadSearchHistoryCallBack<SearchHistory>
